    ...
    <form method="post" action="{{ route('password.update') }}" onsubmit="updatePassword(event)" class="mt-6 space-y-6">
        ...
        <div class="form-group row">
            <label for="update_password_current_password"
                class="col-sm-12 col-form-label">{{ __('Current Password') }}</label>
            <div class="col-sm-7">
        ...
        <div class="form-group row">
            <label for="update_password_password" class="col-sm-12 col-form-label">{{ __('New Password') }}</label>
            <div class="col-sm-7">
        ...
        <div class="form-group row">
            <label for="update_password_password_confirmation"
                class="col-sm-12 col-form-label">{{ __('Confirm Password') }}</label>
            <div class="col-sm-7">
